    ...
    <div className="bg-white rounded-xl border border-gray-100 shadow-card p-5">
      <div className="flex items-start justify-between mb-4">
        <div>
          ...
          {sprint.goal && (
            <p className="text-xs text-gray-500 mt-0.5 line-clamp-2">{sprint.goal}</p>
          )}
        </div>
      ...
      <div className="space-y-3">
        ...
        <div>
          <div className="flex justify-between text-xs mb-1">
            ...
            <span className="font-medium text-gray-700">
              {spProgress.completed} / {spProgress.total} SP
            </span>
          </div>
      ...
      <div className="flex items-center gap-3 mt-4 pt-4 border-t border-gray-50">
        <Pill color="#F59E0B" label="In Progress" count={inProgressCount} />
        <Pill color="#7C3AED" label="In Review" count={reviewCount} />
        <Pill color="#059669" label="Done" count={doneCount} />
